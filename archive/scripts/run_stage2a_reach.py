...
from kinematics.diff_ik import differential_ik_pose
...
def controller(model, data):
    try:
        ...
        ee_site = site_ids["ee_site"]
        x_des = obj_pos + np.array([0.0, 0.0, 0.12])
    
        dq  = differential_ik_pose(model, data, ee_site ,joint_ids, x_des, R_des, lam = 0.05)
